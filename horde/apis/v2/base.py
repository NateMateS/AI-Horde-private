...
class TransferKudos(Resource):
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The sending user's API key.",
        location="headers",
    )
    parser.add_argument(
        "Client-Agent",
...
class AwardKudos(Resource):
    ...
    parser.add_argument(
        ...
        required=False,
        default=100,
        help="The amount of kudos to award.",
        location="json",
    )
...
class Workers(Resource):
    ...
    get_parser.add_argument(
        ...
        default=None,
        type=str,
        help="Filter the workers by type (image, text or interrogation).",
        location="args",
    )
...
class WorkerSingle(Resource):
    ...
    put_parser.add_argument(
        ...
        type=bool,
        required=False,
        help="Set to true to put this worker into maintenance.",
        location="json",
    )
    put_parser.add_argument(
        "maintenance_msg",
    ...
    put_parser.add_argument(
        ...
        type=bool,
        required=False,
        help="Set to true to pause this worker.",
        location="json",
    )
    put_parser.add_argument(
        "info",
        type=str,
        required=False,
        help="You can optionally provide a server note which will be seen in the server details. No profanity allowed!",
        location="json",
    )
    put_parser.add_argument(
        "name",
        type=str,
        required=False,
        help="When this is set, it will change the worker's name. No profanity allowed!",
        location="json",
    )
    put_parser.add_argument(
        "team",
        type=str,
        required=False,
        help="The team ID towards which this worker contributes kudos.",
        location="json",
    )
    ...
    @api.marshal_with(
        models.response_model_worker_modify,
        code=200,
...
class Users(Resource):
    ...
    get_parser.add_argument(
        ...
        default=1,
        type=int,
        help="Which page of results to return. Each page has 25 users.",
        location="args",
    )
    get_parser.add_argument(
        "sort",
        ...
        default="kudos",
        type=str,
        help="How to sort the returned list.",
        location="args",
    )
...
class UserSingle(Resource):
    ...
    get_parser.add_argument(
        ...
        type=str,
        required=False,
        help="The Admin, Mod or Owner API key.",
        location="headers",
    )
    get_parser.add_argument(
        "Client-Agent",
    ...
    @api.expect(get_parser)
    @api.marshal_with(
        models.response_model_user_details,
        code=200,
    ...
    parser.add_argument(
        ...
        type=int,
        required=False,
        help="The amount of kudos to modify (can be negative).",
        location="json",
    )
    parser.add_argument(
        "concurrency",
        type=int,
        required=False,
        help="The amount of concurrent request this user can have.",
        location="json",
    )
    parser.add_argument(
        "usage_multiplier",
        type=float,
        required=False,
        help="The amount by which to multiply the users kudos consumption.",
        location="json",
    )
    parser.add_argument(
        "worker_invited",
        type=int,
        required=False,
        help="Set to the amount of workers this user is allowed to join to the horde when in worker invite-only mode.",
        location="json",
    )
    parser.add_argument(
        "moderator",
        type=bool,
        required=False,
        help="Set to true to Make this user a horde moderator.",
        location="json",
    )
    parser.add_argument(
        "public_workers",
        type=bool,
        required=False,
        help="Set to true to Make this user a display their worker IDs.",
        location="json",
    )
    parser.add_argument(
        "username",
        type=str,
        required=False,
        help="When specified, will change the username. No profanity allowed!",
        location="json",
    )
    parser.add_argument(
        "monthly_kudos",
        type=int,
        required=False,
        help="When specified, will start assigning the user monthly kudos, starting now!",
        location="json",
    )
    parser.add_argument(
        "trusted",
        type=bool,
        required=False,
        help="When set to true,the user and their servers will not be affected by suspicion.",
        location="json",
    )
    parser.add_argument(
        "flagged",
        type=bool,
        required=False,
        help="When set to true, the user cannot tranfer kudos and all their workers are put into permanent maintenance.",
        location="json",
    )
    parser.add_argument(
        "customizer",
    ...
    @api.marshal_with(
        models.response_model_user_modify,
        code=200,
...
class FindUser(Resource):
    ...
    get_parser.add_argument(
        ...
        type=str,
        required=False,
        help="User API key we're looking for.",
        location="headers",
    )
    get_parser.add_argument(
        "Client-Agent",
...
class Models(Resource):
    ...
    get_parser.add_argument(
        ...
        default="image",
        type=str,
        help="Filter the models by type (image or text).",
        location="args",
    )
    get_parser.add_argument(
        "min_count",
        ...
        default=None,
        type=int,
        help="Filter only models that have at least this amount of threads serving.",
        location="args",
    )
    get_parser.add_argument(
        "max_count",
...
class HordeLoad(Resource):
    ...
    def get(self):
        ...
        (
            load_dict["worker_count"],
            load_dict["thread_count"],
        ) = database.count_active_workers()
        (
            load_dict["interrogator_count"],
            load_dict["interrogator_thread_count"],
        ) = database.count_active_workers("interrogation")
        (
            load_dict["text_worker_count"],
            load_dict["text_thread_count"],
        ) = database.count_active_workers("text")
...
class HordeModes(Resource):
    ...
    get_parser.add_argument(
        ...
        type=str,
        required=False,
        help="The Admin or Owner API key.",
        location="headers",
    )
...
class Teams(Resource):
    ...
    @api.expect(get_parser)
    @api.marshal_with(
        models.response_model_team_details,
        code=200,
    ...
    @api.marshal_with(
        models.response_model_team_modify,
        code=200,
...
class TeamSingle(Resource):
    ...
    patch_parser.add_argument(
        ...
        type=str,
        required=False,
        help="The Moderator or Creator API key.",
        location="headers",
    )
    patch_parser.add_argument(
        "Client-Agent",
...
class OperationsIP(Resource):
    ...
    @api.expect(get_parser)
    @api.marshal_with(
        models.response_model_ip_timeout,
        code=200,
...
class Filters(Resource):
    ...
    get_parser.add_argument(
        ...
        default=None,
        required=False,
        help="Only return filter containing this word.",
        location="args",
    )
    ...
    @api.expect(get_parser)
    @api.marshal_with(
        models.response_model_filter_details,
        code=200,
    ...
    put_parser.add_argument(
        ...
        type=str,
        required=False,
        help="Optional description about this filter.",
        location="json",
    )
    put_parser.add_argument(
        "replacement",
        ...
        default="",
        required=False,
        help="Replacement string to use for this regex.",
        location="json",
    )
    ...
    post_parser.add_argument(
        ...
        default=None,
        required=False,
        help="Only check if it matches a specific type.",
        location="json",
    )
    ...
    @api.marshal_with(
        models.response_model_prompt_suspicion,
        code=200,
...
class FilterRegex(Resource):
    ...
    @api.expect(get_parser)
    @api.marshal_with(
        models.response_model_filter_regex,
        code=200,
...
class SharedKey(Resource):
    ...
    put_parser.add_argument(
        ...
        required=False,
        default=5000,
        help="The amount of kudos limit available to this key.",
        location="json",
    )
    put_parser.add_argument(
        "expiry",
        ...
        required=False,
        default=-1,
        help="The amount of days which this key will stay active.",
        location="json",
    )
    put_parser.add_argument(
        "name",
    ...
    put_parser.add_argument(
        ...
        required=False,
        default=-1,
        help="The maximum number of pixels this key can generate per job.",
        location="json",
    )
    put_parser.add_argument(
        "max_image_steps",
        ...
        required=False,
        default=-1,
        help="The maximum number of steps this key can use per job.",
        location="json",
    )
    put_parser.add_argument(
        "max_text_tokens",
        ...
        required=False,
        default=-1,
        help="The maximum number of tokens this key can generate per job.",
        location="json",
    )
...
class SharedKeySingle(Resource):
    ...
    patch_parser.add_argument(
        ...
        type=int,
        required=False,
        help="The amount of days from today which this key will stay active.",
        location="json",
    )
    patch_parser.add_argument(
        "name",
